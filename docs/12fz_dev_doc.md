...
> 项目：12FZ — 企业中台
   ...
   180|
   181|
   182|| **Go聊天系统+四大核心能力** | @gong3 | WebSocket通讯、企内企外群聊、加好友、AI联系人集成、中央项目管理API、中央记忆API、中央技能库注册中心 |
...
| **go.12fz.com** | **数造企业中台**（Go+PG，并行生产站） |   273|| chat系统已上线HTTPS，Nginx反向代理 `/api/` → Go后端:8081 |
   ...
   378|| 序号 | 模块 | 语言 | 负责人 | 人天 |
   379||:----:|------|:----:|:------:|:----:|
   380|| 4.1 | 中央项目管理（bot状态标识+协作看板） | Go+TS | gong3+待定 | 10 |
...
**落地实施：**
- 后端：Go实现状态API（GET/POST bot状态、项目进度、依赖链）— @gong3
- 前端：控制台增加「中央项目管理」入口 + 看板页面 — @gong3
