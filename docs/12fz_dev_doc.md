...
- 卡住超过2小时不解决 → 群里@我，我来协调
   ...
   889|```
   890|
### 11.2b 中央项目管理（2026-06-05 新增，v10.20 改名）
...
| 版本 | 日期 | 变更摘要 |
|:----:|:----:|:---------|
| **v10.20** | **2026-06-10** | **AI协作面板正式更名为「中央项目管理」（老板确认）。11.2b节标题和全文改名，控制台架构图同步更新。本次讨论确认：中央项目管理=一个面板看清每个人在做什么、做了什么、卡在哪。状态标识+项目进度+依赖关系三要素构成。该模块保持Phase4由gong3负责开发（Go+TS）。** |
